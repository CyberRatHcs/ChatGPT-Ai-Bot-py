...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6242875268:AAFwKLXhKUMhFVPWi8KHWigeaX15-QAOVZI"
else:
    tgkey = tgenv
print(tgenv)
